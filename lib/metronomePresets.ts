...
export type MetronomeSoundPreset = {
  id: string;
  label: string;
  /** require() result for accent (beat 1) - used with Asset.fromModule for URI */
  hi: number;
  /** require() result for normal beats */
  lo: number;
};
...
const presets: MetronomeSoundPreset[] = [
  ...
  { id: "perc_stick", label: "Stick", hi: require("@/assets/metronomes/Perc_Stick_hi.wav"), lo: require("@/assets/metronomes/Perc_Stick_lo.wav") },
  { id: "perc_tamb_a", label: "Tamb A", hi: require("@/assets/metronomes/Perc_Tamb_A_hi.wav"), lo: require("@/assets/metronomes/Perc_Tamb_A_lo.wav") },
  { id: "perc_tamb_b", label: "Tamb B", hi: require("@/assets/metronomes/Perc_Tamb_B_hi.wav"), lo: require("@/assets/metronomes/Perc_Tamb_B_lo.wav") },
  { id: "perc_tamb_c", label: "Tamb C", hi: require("@/assets/metronomes/Perc_Tamb_C_hi.wav"), lo: require("@/assets/metronomes/Perc_Tamb_C_lo.wav") },
  { id: "perc_tamb_d", label: "Tamb D", hi: require("@/assets/metronomes/Perc_Tamb_D_hi.wav"), lo: require("@/assets/metronomes/Perc_Tamb_D_lo.wav") },
  { id: "perc_teeth", label: "Teeth", hi: require("@/assets/metronomes/Perc_Teeth_hi.wav"), lo: require("@/assets/metronomes/Perc_Teeth_lo.wav") },
  { id: "perc_tongue", label: "Tongue", hi: require("@/assets/metronomes/Perc_Tongue_hi.wav"), lo: require("@/assets/metronomes/Perc_Tongue_lo.wav") },
  { id: "perc_trashcan", label: "Trash Can", hi: require("@/assets/metronomes/Perc_TrashCan_hi.wav"), lo: require("@/assets/metronomes/Perc_TrashCan_lo.wav") },
  { id: "perc_whistleparty", label: "Whistle Party", hi: require("@/assets/metronomes/Perc_WhistleParty_hi.wav"), lo: require("@/assets/metronomes/Perc_WhistleParty_lo.wav") },
  { id: "synth_tick_a", label: "Synth Tick A", hi: require("@/assets/metronomes/Synth_Tick_A_hi.wav"), lo: require("@/assets/metronomes/Synth_Tick_A_lo.wav") },
  { id: "synth_tick_b", label: "Synth Tick B", hi: require("@/assets/metronomes/Synth_Tick_B_hi.wav"), lo: require("@/assets/metronomes/Synth_Tick_B_lo.wav") },
  { id: "synth_tick_c", label: "Synth Tick C", hi: require("@/assets/metronomes/Synth_Tick_C_hi.wav"), lo: require("@/assets/metronomes/Synth_Tick_C_lo.wav") },
  { id: "synth_tick_d", label: "Synth Tick D", hi: require("@/assets/metronomes/Synth_Tick_D_hi.wav"), lo: require("@/assets/metronomes/Synth_Tick_D_lo.wav") },
  { id: "synth_tick_e", label: "Synth Tick E", hi: require("@/assets/metronomes/Synth_Tick_E_hi.wav"), lo: require("@/assets/metronomes/Synth_Tick_E_lo.wav") },
